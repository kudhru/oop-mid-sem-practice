...
class CustomPerson {
    ...
    public CustomPerson(String name, Integer age) {
        this.name = name;
        this.age = age;
    }
...
public class ReflectionExample {
    public static void main(String[] args) {
        try {
            ...
            Class<?> personClass = Class.forName("CustomPerson");
            ...
            String x = "Alice";
            Integer y = 4;
            Constructor<?> constructor = personClass.getConstructor(x.getClass(), y.getClass());
...
//            Constructor<?> constructor = personClass.getConstructor(String.class, int.class);
            ...
            Object personObj1 = constructor1.newInstance();
